/* ==============================================
   Skyline Logic - Telegram Bildirim Motoru v7.4 (EXPORT HATALARI KESİN ÇÖZÜM)
   ============================================== */
 ...
 * **EXPORT KESİNLİKLE BURADA**
 */
export const sendBuyDetected = async (message, txHash) => { // <-- EXPORT BURADA
  if (!bot) return; 
